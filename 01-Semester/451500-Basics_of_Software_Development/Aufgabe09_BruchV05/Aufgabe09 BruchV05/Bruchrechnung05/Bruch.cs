 ...
 * 
 * Zugabe
 * - Überladene Operatoren == und !=
 * - Übeschreiben der von Object geerbten Methoden Equals und GetHashCode
 *
...
namespace Bruchrechnung
{
    class Bruch
    {
        ...
        #region Zugabe Gleichheit und Ungleicheit
        public static bool operator ==(Bruch a,Bruch b)
        {
            // Brüche gleichnamig machen und Zähler vergleichen
            int links = a.numerator * b.denominator;
        ...
        // Überschreiben der von Object geerbten 
        // Instanzmethoden Equals und GetHashCode
        // Sind Voraussetzung für das Überladen von == und !=
        public override bool Equals (Object o)
        {
            // Wiederverwendung des überladenen Operators ==
            return this == (Bruch)o;
        }

        public override int GetHashCode()
        {
            // Hashcode individuell berechnen
            // Hier beispielhaft durch numerator XOR denominator
