...
// Lösung Aufgabe 01 unter Verwendung von Instanzmethoden
...
namespace GSE  
{
    class Helpers
    {
        ...
        public void zeigeTitel(string titel)
        {
            // Konsolfenster löschen
            //Console.Clear();
            // Eigenschaft title setzen
        ...
        public void zeigeTitel(string titel, string ueberschrift)
        {
            // Konsolfenster löschen
            Console.Clear();
            // Eigenschaft title setzen
