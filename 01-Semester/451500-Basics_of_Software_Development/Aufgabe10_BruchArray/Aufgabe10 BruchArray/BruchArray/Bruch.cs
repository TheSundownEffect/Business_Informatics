...
namespace Bruchrechnung
{
    class Bruch
    {
        ...
        // oder auf die Klassenmethode subtract zurückgeführt werden
        public static Bruch operator -(Bruch a, Bruch b)
        {
            return a + -b;
            // return Bruch.subtract(a, b);
        }

        // Ist unmittelbar zurückzuführen auf die Subtraktion
        // zweier Brüche
        public static Bruch operator -(Bruch a, int zahl)
        {
            return a - new Bruch(zahl);
        ...
        // Ist unmittelbar zurückzuführen auf die Multiplikation
        // zweier Brüche
        public static Bruch operator *(Bruch a, int zahl)
        {
            return a * new Bruch(zahl);
        ...
        // Ist unmittelbar zurückzuführen auf die Division
        // zweier Brüche
        public static Bruch operator /(Bruch a, int zahl)
        {
            return a / new Bruch(zahl);
